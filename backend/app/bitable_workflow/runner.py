...
async def _create_extra_views(
    ...
    view_plan: list[tuple[str, str, str, str | None, str | None]] = [
        ...
        (task_tid, "👔 拍板人任务", "grid", "工作流路由", "等待拍板"),
        (task_tid, "⚙️ 执行人任务", "grid", "工作流路由", "直接执行"),
        (task_tid, "🧪 复核人任务", "grid", "待安排复核", "True"),
        (task_tid, "🔁 待进入复盘", "grid", "是否进入复盘", "False"),
        (task_tid, "⏳ 待拍板确认", "grid", "是否已拍板", "False"),
        (task_tid, "🚀 待执行落地", "grid", "是否已执行落地", "False"),
