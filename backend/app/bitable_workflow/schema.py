...
TASK_FIELDS = [
    ...
    {"field_name": "拍板负责人OpenID", "type": TEXT_FIELD_TYPE},
    {"field_name": "执行负责人", "type": TEXT_FIELD_TYPE},
    {"field_name": "执行负责人OpenID", "type": TEXT_FIELD_TYPE},
    {
        "field_name": "执行截止时间",
        "type": DATE_FIELD_TYPE,
        "ui_type": "DateTime",
    ...
    {"field_name": "复核负责人OpenID", "type": TEXT_FIELD_TYPE},
    {"field_name": "复盘负责人", "type": TEXT_FIELD_TYPE},
    {"field_name": "复盘负责人OpenID", "type": TEXT_FIELD_TYPE},
    {"field_name": "汇报对象OpenID", "type": TEXT_FIELD_TYPE},
    {
        "field_name": "复核SLA小时",
        "type": NUMBER_FIELD_TYPE,
        "ui_type": "Number",
...
TEMPLATE_CENTER_FIELDS = [
    ...
    {"field_name": "默认汇报对象OpenID", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认拍板负责人", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认拍板负责人OpenID", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认执行负责人", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认执行负责人OpenID", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认复核负责人", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认复核负责人OpenID", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认复盘负责人", "type": TEXT_FIELD_TYPE},
    {"field_name": "默认复盘负责人OpenID", "type": TEXT_FIELD_TYPE},
    {
